...
export type AddResultType<A, B> = (A extends BladeScalar ? BladeScalar : {}) &
...
export const add = <
  A extends OptionalMultiVector,
  B extends OptionalMultiVector
>(
  a: A,
  b: B
): AddResultType<A, B> => {
  const result: any = {
    scalar:
      a.scalar !== undefined || b.scalar !== undefined
        ? (a.scalar || 0) + (b.scalar || 0)
        : undefined,
    e0:
      a.e0 !== undefined || b.e0 !== undefined
        ? (a.e0 || 0) + (b.e0 || 0)
        : undefined,
    e1:
      a.e1 !== undefined || b.e1 !== undefined
        ? (a.e1 || 0) + (b.e1 || 0)
        : undefined,
    e2:
      a.e2 !== undefined || b.e2 !== undefined
        ? (a.e2 || 0) + (b.e2 || 0)
        : undefined,
    e01:
      a.e01 !== undefined || b.e01 !== undefined
        ? (a.e01 || 0) + (b.e01 || 0)
        : undefined,
    e02:
      a.e02 !== undefined || b.e02 !== undefined
        ? (a.e02 || 0) + (b.e02 || 0)
        : undefined,
    e12:
      a.e12 !== undefined || b.e12 !== undefined
        ? (a.e12 || 0) + (b.e12 || 0)
        : undefined,
    e012:
      a.e012 !== undefined || b.e012 !== undefined
        ? (a.e012 || 0) + (b.e012 || 0)
        : undefined,
  };
...
export type DualResultType<A> = (A extends BladeScalar ? BladeE012 : {}) &
...
export const dual = <A extends OptionalMultiVector>(
  a: A
): DualResultType<A> => {
  const result: any = {
...
export type GeometricProductResultType<A, B> = (A extends BladeScalar
  ? (B extends BladeScalar ? BladeScalar : {}) &
      (B extends BladeE0 ? BladeE0 : {}) &
      (B extends BladeE1 ? BladeE1 : {}) &
      (B extends BladeE2 ? BladeE2 : {}) &
...
export const geometricProduct = <
  A extends OptionalMultiVector,
  B extends OptionalMultiVector
>(
  a: A,
  b: B
): GeometricProductResultType<A, B> => {
...
export type InnerProductResultType<A, B> = (A extends BladeScalar
  ? (B extends BladeScalar ? BladeScalar : {}) &
      (B extends BladeE0 ? BladeE0 : {}) &
      (B extends BladeE1 ? BladeE1 : {}) &
      (B extends BladeE2 ? BladeE2 : {}) &
      ...
      (B extends BladeE012 ? BladeE012 : {})
  : {}) &
  (A extends BladeE0 ? (B extends BladeScalar ? BladeE0 : {}) : {}) &
  (A extends BladeE1
    ? (B extends BladeScalar ? BladeE1 : {}) &
        (B extends BladeE1 ? BladeScalar : {}) &
        (B extends BladeE01 ? BladeE0 : {}) &
...
export type ExteriorProductResultType<A, B> = (A extends BladeScalar
  ? (B extends BladeScalar ? BladeScalar : {}) &
      (B extends BladeE0 ? BladeE0 : {}) &
      (B extends BladeE1 ? BladeE1 : {}) &
      (B extends BladeE2 ? BladeE2 : {}) &
  ...
  (A extends BladeE12
    ? (B extends BladeScalar ? BladeE12 : {}) &
        (B extends BladeE0 ? BladeE012 : {})
    : {}) &
  (A extends BladeE012 ? (B extends BladeScalar ? BladeE012 : {}) : {});

export const exteriorProduct = <
  A extends OptionalMultiVector,
  B extends OptionalMultiVector
>(
  a: A,
  b: B
): ExteriorProductResultType<A, B> => {
  let resultScalar = undefined;
  const scalar_0 = a.scalar !== undefined && b.scalar !== undefined;
  if (scalar_0) {
    resultScalar = 0;
...
export const repr = <A extends OptionalMultiVector>(
  a: A,
  digits: number = 3
): string => {
  let result = "";
  if (a.scalar !== undefined) {
    if (result === "") {
      ...
      result +=
        a.scalar >= 0
          ? " + " + a.scalar.toFixed(digits) + ""
          : " - " + Math.abs(a.scalar).toFixed(digits) + "";
    }
  }
  if (a.e0 !== undefined) {
    if (result === "") {
      ...
      result +=
        a.e0 >= 0
          ? " + " + a.e0.toFixed(digits) + "e0"
          : " - " + Math.abs(a.e0).toFixed(digits) + "e0";
    }
  }
  if (a.e1 !== undefined) {
    if (result === "") {
      ...
      result +=
        a.e1 >= 0
          ? " + " + a.e1.toFixed(digits) + "e1"
          : " - " + Math.abs(a.e1).toFixed(digits) + "e1";
    }
  }
  if (a.e2 !== undefined) {
    if (result === "") {
      ...
      result +=
        a.e2 >= 0
          ? " + " + a.e2.toFixed(digits) + "e2"
          : " - " + Math.abs(a.e2).toFixed(digits) + "e2";
    }
  }
  if (a.e01 !== undefined) {
    if (result === "") {
      ...
      result +=
        a.e01 >= 0
          ? " + " + a.e01.toFixed(digits) + "e01"
          : " - " + Math.abs(a.e01).toFixed(digits) + "e01";
    }
  }
  if (a.e02 !== undefined) {
    if (result === "") {
      ...
      result +=
        a.e02 >= 0
          ? " + " + a.e02.toFixed(digits) + "e02"
          : " - " + Math.abs(a.e02).toFixed(digits) + "e02";
    }
  }
  if (a.e12 !== undefined) {
    if (result === "") {
      ...
      result +=
        a.e12 >= 0
          ? " + " + a.e12.toFixed(digits) + "e12"
          : " - " + Math.abs(a.e12).toFixed(digits) + "e12";
    }
  }
  if (a.e012 !== undefined) {
    if (result === "") {
      ...
      result +=
        a.e012 >= 0
          ? " + " + a.e012.toFixed(digits) + "e012"
          : " - " + Math.abs(a.e012).toFixed(digits) + "e012";
    }
  }
  return result;
};

export const regressiveProduct = <
  A extends OptionalMultiVector,
  B extends OptionalMultiVector
>(
  a: A,
...
export const commutatorProduct = <
  A extends OptionalMultiVector,
  B extends OptionalMultiVector
>(
  a: A,
...
export const exponential = <A extends OptionalMultiVector>(a: A) => {
  ...
  if (s < 0) {
    ...
    return add(
      { scalar: Math.cos(rootS) },
      multiply(a, Math.sin(rootS) / rootS)
    );
  } else if (s > 0) {
    const rootS = Math.sign(s) * Math.sqrt(Math.abs(s));
    return add(
      { scalar: Math.cosh(rootS) },
      multiply(a, Math.sinh(rootS) / rootS)
    );
  } else {
